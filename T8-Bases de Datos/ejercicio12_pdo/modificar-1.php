...
<body style="background-color: burlywood;">
    <h1 style="background-color: orange; color:white;">BASE DE DATOS 2-1 - MODIFICAR 1</h1>
    ...
    try {
        ...
        if (!$resultado) {
            ...
            if(!$resultado) {
                ...
                print "<p>Marque el registro que quiera modificar</p>";
                ...
                foreach($resultado as $valor) {
                    print "<tr>";
                    print "<td style='border:1px solid black;'><input type='radio' name='id' value='".$valor['id']."'></td>";
