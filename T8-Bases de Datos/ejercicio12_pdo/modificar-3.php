...
<body style="background-color: burlywood;">
    <h1 style="background-color: orange; color:white;">BASE DE DATOS 2-1 - MODIFICAR 3</h1>
                ...
                if(preg_match("/^(([A-Za-zÁÉÍÓÚÑáéíóúñÑ])+(\s)*([A-Za-zÁÉÍÓÚÑáéíóúñÑ])*)$/",$nombre) 
                    ...
                    if (!$resultado) {
                        ...
                        print "    <p>El registro <b>$nombre $apellidos</b> ya existe. <br> 
                            No se ha modificado/actualizado el registro seleccionado.</p> <br>";
                    } else {
                        ...
                        if($conexion->query($consulta)) {
                            ...
                            print "ERROR: Registro de $nombre $apellidos NO se ha modificado correctamente (ID= $id).<br>";
                        }
                    }
