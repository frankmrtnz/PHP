...
<body style="background-color: burlywood;">
    <h1 style="background-color: orange; color:white;">BASE DE DATOS 1-6 - BUSCAR 2</h1>
    ...
    if(isset($_REQUEST['buscar'])) {
        ...
        $consulta = "SELECT * FROM personas WHERE nombre = '$nombre' OR apellidos = '$apellidos'";

        $resultado = mysqli_query($conexion,$consulta) or die("No se ha podido hacer la consulta de búsqueda. ERROR: ".mysqli_error($conexion));
        ...
        print "<p>No ha pulsado el botón de 'Buscar'</p>";
    }
