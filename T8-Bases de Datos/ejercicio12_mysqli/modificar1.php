...
<body style="background-color: burlywood;">
    <h1 style="background-color: orange; color:white;">BASE DE DATOS 1-6 - MODIFICAR 1</h1>
    ...
    while($columna = mysqli_fetch_array($resultado)) {
        print "<tr>";
        print "<td style='border:1px solid black;'><input type='radio' name='id' value='".$columna['id']."'></td>";
