...
function enviarEmail($nombre, $email, $asunto, $mensaje) {
    ...
    if ($ok) {
        ...
        print "<p>Haz <a href='ej3.php'>click para volver al formulario</a></p>";
    } else {
        $html  = "<html>";
		$html .= "<head>";

		// Después de 5 segundos de mostrarse esta página web de error se redirigiría a la URL especificada.
		$html .= "<meta http-equiv='refresh' content='5;url=ej3.php'>";

		$html .= "</head>";
		$html .= "<body>";
        $html .= "<p style='color:red;'>El E-Mail NO ha sido enviado</p>";
        $html .= "<p>Haz <a href='ej3.php'>click para volver al formulario</a></p>";
